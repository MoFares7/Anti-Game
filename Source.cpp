...
LRESULT	CALLBACK WndProc(HWND, UINT, WPARAM, LPARAM);	// Declaration For WndProc
														/*case WM_MOUSEMOVE:											isRClicked = true; break;
														*/
...
int InitGL(GLvoid)										// All Setup For OpenGL Goes
{
	// Load Tank Model
	//case = new Model_3DS();
	//case->Load("Resources/Textures/CamCase.3DS");
	// Tank Model Textures
	//tankTex.LoadBMP("Resources/Textures/right.bmp");
	//leaf.LoadBMP("Resources/Textures/leaf.bmp");
	//fares.LoadBMP("Resources/Textures/car.bmp");
	...
	hardModel = new HardDrive();
	roomModel = new mainroom();
	mirror = new Mirror();
	//gContext = new CONTEXT();
	return TRUE;										// Initialization Went OK
}
/*tank->Materials[0].tex = tankTex;
tank->Materials[1].tex = tankTex;
tank->scale = 0.3;
tank->Draw();
*/
void controle() {
